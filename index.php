...
$blogs = [
    [
        ...
        'author' => 'Colorlib',
        'date' => 'March 15, 2018',
        'commentsIcon' => "fa fa-comments",
        'comments' => "3",
        'text' => "How to Find the Video Games of Your Youth",
    ],
    [
                ...
                <div class="col-md-6">
                  <a href="blog-single.html" class="blog-entry element-animate" data-animate-effect="fadeIn">
                    ...
                    <div class="blog-content-body">
                      <div class="post-meta">
                        <span class="author mr-2"><img src="<?=$blog['avatar']?>" alt="Colorlib"><?=$blog['author']?> </span>&bullet;
                        <span class="mr-2"><?=$blog['date']?> </span> &bullet;
                        <span class="ml-2"><span class="fa fa-comments"></span> <?=$blog['comments']?></span>
                      </div>
                      <h2><?=$blog['text']?> </h2>
                    </div>
                  </a>
